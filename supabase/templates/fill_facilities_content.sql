-- Điền nhanh địa chỉ + mô tả thật cho 10 cơ sở.
-- Cách dùng:
--   1. Điền nội dung thật vào phần '...' của từng dòng address/description bên dưới
--      (bỏ trống address là 'null' nếu chưa có, xoá cặp nháy '' quanh null).
...
update public.facilities set
  address = '...',
  description = '...'
where slug = 'huynh-de-nhu-nghia'; -- Cơ Sở Khiếm Thị Huynh Đệ Như Nghĩa

update public.facilities set
  address = '...',
  description = '...'
where slug = 'luu-xa-emmanuel'; -- Lưu Xá Emmanuel

update public.facilities set
  address = '...',
  description = '...'
where slug = 'noi-tru-thanh-gia'; -- Nội Trú Thánh Gia

update public.facilities set
  address = '...',
  description = '...'
where slug = 'noi-tru-thang-tien'; -- Nội Trú Thăng Tiến
...
update public.facilities set
  address = '...',
  description = '...'
where slug = 'mam-non-thien-ca'; -- Mầm Non Thiên Ca

update public.facilities set
  address = '...',
  description = '...'
where slug = 'mam-non-son-ca'; -- Mầm Non Sơn Ca
...
update public.facilities set
  address = '...',
  description = '...'
where slug = 'phong-kham-suoi-thong'; -- Phòng Khám Suối Thông
